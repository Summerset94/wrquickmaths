...

    {
      description:
        <div className="abilityDescription">
          ...
          <br />
          <p>
            For 6 seconds gain 250 Attack Range and <span className="stat--ad">25 / 40 / 55 bonus attack damage</span> and transform attacks into piercing bolts that hit every enemy in a line.
          </p>
