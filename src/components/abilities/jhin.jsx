  ...
  const abilities = [
    {
      description:
        <div className="abilityDescription">
          ...
          <p>
            Jhin's <span className="stat--ad">Attack damage</span>  scales with <span className="stat--as">bonus Attack Speed</span> and <span className="stat--critChance">Critical rate</span>.
            </p>
        </div>
    },
