  ...
  const calculations = useMemo(() => {
    ...
    return {
      ...
      q: {
        ...
        text: {
          damage: <span className="stat--ap">{q.damage.base} / {q.damage.base + q.damage.growth} / {q.damage.base + q.damage.growth * 2} / {q.damage.base + q.damage.growth * 3} (+55% AP) Magic damage</span>
        }
      },
