...

    {
      description:
        <div className="abilityDescription">
          ...
          <p>
            Yuumi's attacks against champions grant her <abbr title="60 + 25 per Level +25% AP" className="stat--hp">{Math.round(35 + (25 * currentLevel)+ (atk.ap * 25 / 100))} damage shield</abbr>. This effect has a <abbr title="at level 1 / 5 / 9 / 13">18 / 15 / 12 / 9s second cooldown</abbr>.
          </p>
...

    {
      description:
        <div className="abilityDescription">
          ...
          <br />
          <p>
           <b>Passive:</b> Increases <span className="stat--armor">Attached ally's</span> <span className="stat--magres">Adaptive Force</span> by <span className="stat--ad">7.5 / 9 / 10.5 / 12 (+8 / 11 / 14 / 17% ally's bonus AD)</span> or <span className="stat--ap">15 / 18 / 21 / 24 (+13 / 15 / 17 / 19% ally's AP)</span>.
          </p>
