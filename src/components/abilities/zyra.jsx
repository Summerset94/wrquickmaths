...

    {
      description:
        <div className="abilityDescription">
          ...
          <br />
          <p>
           Vines spread out and burst into spines dealing <span className="stat--ap">60 / 110 / 160 / 210 (+50%AP) magic damage</span> and sprouting 1 <b className="stat--armor">Thorn Spitter</b>
          </p>
        </div>
    },
