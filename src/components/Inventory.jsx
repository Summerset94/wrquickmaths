...
export default function Inventory({base, bonus, total, handleBonusChange, currentLevel, index, itemEffects, updateItemEffects}) { 
  ...
  const modifierMres = ((1 - (100/(100 + (targetMres))))*(1 + (target.bootsPassive === 'Mercury' ? 0.12 : 0) + (target.forceOfNature ? 0.25 : 0)));
