...
export default function Inventory({base, bonus, total, handleBonusChange, currentLevel, bonusEffects, switchHat, switchTwinguard, switchFON, index}) { 
...

    {
      ...
      description: 
        <div className='itemDescription'>
          ...
          <p><b>Overkill:</b> Increases <span className="stat--ap">Ability Power</span> by <abbr title="20-45% based on level">{total.ap * (20 + 25/14*level)}</abbr></p>          
...

    {
      ...
      description: 
        <div className='itemDescription'>
          ...
          <p><b>Inevitable Demise: </b> Abilities and empowered attacks <span className="stat--vamp">Critically Strike</span> for 20% bonus damage against enemies below <span className='stat--hp'>35% <abbr title="For current target">({Math.round(total.health * 35 / 100)})</abbr> Health</span></p>
        </div>
...

    {
      ...
      description: 
        <div className='itemDescription'>
          ...
          <p><b>Spellweaving: </b>Active abilities and empowered attacks grant <abbr title="30 + 70% Ability Haste"><b>{Math.round(30 + (total.ah * 70 /100))} Movement Speed</b></abbr> after dealing damage to enemy champion. This movement speed decays over 2 seconds. Each source has 1s cooldown for triggering the effect. Only <b>Ability Haste</b> from items contributes to Spellweaving's movement speed</p>
        </div>
  ...
  //     description: 
  //       <div className='itemDescription'>
  //         <img src="../images/items/Magnetic_Blaster.png" alt="itemIcon" className="itemIcon" />
  ...
  //         <p><b>Mana Charge:</b> Increase max Mana by <span className='stat--mana'>10</span> every attack or when Mana is spent. Triggers up to 3 times every 12 seconds Caps at <span className='stat--mana'>700</span> bonus Mana and transforms into <b>Muramana</b> </p>
  //       </div>
  ...
  //         <h3 className='stat--ap'>+{100} Ability Power</h3>
  //         <p><b>Overkill:</b> Increases <span className="stat--ap">Ability Power</span> by <abbr title="20-45% based on level">{bonusEffects.rabadon}</abbr></p>
  ...
  //     description: 
  //       <div className='itemDescription'>
  //         <img src="../images/items/Oceanids_Trident.png" alt="itemIcon" className="itemIcon" />
...
//  Logic for combining all bonus stat from items
  const inventoryNums = useMemo(() => {
   ...
   useEffect(() => {    
    ...
    return (
      <div className="inventoryStore">
        {items.map((item) => (
          <button className="inventoryButton" key={item.name} onClick={() => addToInventory(item, currentSlot) }>
    ...
    return (
      <div className="inventoryStore">
        {items.map((item, index) => (
          <button className="inventoryButton" key={item.name} onClick={() => setSelectedBoots(item) }>
            <img src={item.icon} alt="Item image" className="inventory-itemIcon"/>
            <p>{item.name}</p>
          </button>          
        ))}
  ...
  return (
    <div className='inventoryTile'> 
         <div className="inventory-equipped">
          {Items.map((item) => (
            <div className="inventroy-equippedTile">
              <button key={item.index} className="button" onClick={() => deleteItem(item)}>
                Remove item
              </button>
              <img src={item.icon} alt="Item image" className="inventory-itemIcon"/>
              <p>{item.name}</p>
          ...
          <div className="inventroy-equippedTile">
            <button key={selectedBoots.name} className="button" onClick={() => setSelectedBoots(bootsItemData[0])}>
              Remove Boots
            </button>
            <img src={selectedBoots.icon} alt="Item image" className="inventory-itemIcon"/>
      ...
      <div className="inventory-itemSection">        
